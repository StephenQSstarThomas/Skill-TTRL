...
Your task: merge and deduplicate these skills into AT MOST 3 high-quality skills. \
Aggressively combine overlapping ideas and keep only the most novel and useful insights.
...
## Instructions:
- Output a JSON array of merged skills (MAXIMUM 3 skills)
- Each skill: {{"title": "3-6 word title", "content": "1-3 sentence actionable description"}}
- Be aggressive: combine similar skills, prioritize the most impactful
- Do NOT include skills that are trivially obvious or too specific to this problem
